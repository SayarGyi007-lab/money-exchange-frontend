...
//   return (
//     <div className="flex flex-col justify-center items-center h-screen w-screen bg-orange-100 space-y-4">
//       {/* White Box */}
//       <div className='items-center justify-center mx-auto max-w-md bg-white rounded-md p-6 shadow-md'>
//         <h2 className='text-center text-2xl font-bold mb-3 text-amber-500'>Sell Rates</h2>
...
//         <button className="px-6 py-2 bg-green-500 text-white rounded-md hover:bg-green-600">Exchange</button>
//       </div>
//     </div>
//   )
// }
